...
import imageKitInstance from '../services/imgkit.service.js';
...
export const handleUploadProfilePicture = asyncHandler(async (req, res, next) => {
...
export const handleDeleteAccount = asyncHandler(async (req, res, next) => {
